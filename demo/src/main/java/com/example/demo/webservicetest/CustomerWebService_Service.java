 ...
 * 
 */
@WebServiceClient(name = "customerWebService", targetNamespace = "http://service.dlyx.ccie.com", wsdlLocation = "http://10.126.15.230:9220/gapi/webservice/customer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.126.15.230:9220/gapi/webservice/customer?wsdl");
